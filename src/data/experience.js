...
export const certificationsData = [
  {
    id: 1,
    name: 'Software Engineering Certificate of Completion (Back-end)',
    issuer: 'African Leadership Experience',
    issueDate: 'Nov 2024',
    expiryDate: 'Lifetime',
    credentialId: 'RFBHEe5276',
    icon: <Engineering />,
    logo: '/images/certifications/alx.jpg',
    description:
      'This certificate recognizes Precious Ebisine Okoyen for completing the 12 Month ALX Software Engineering Programme with a specialization in Back-end. The program was powered by Holberton Inc. and was completed on November 5th, 2024.',
    skills: [
      'Advanced Python',
      'Node.js',
      'Time Management',
  ...
  },
  {
    ...
    issueDate: 'Jul 2024',
    expiryDate: 'Lifetime',
    credentialId: 'b805f5c9-34c8-4add-a9a9-2a7877141d8f',
    icon: <School />,
    logo: '/images/certifications/cisco.png',
    description:
      'Statement of Achievement for English for IT 1 Course organised by 3MTT. Verified achievement from Cisco.',
    skills: ['English'],
  },
  {
    id: 7,
    ...
    expiryDate: 'Lifetime',
    credentialId:
      '0732d1aa75cd6712097c6a8b9012449ab2833710030d769845e9b590cd53462b',
    icon: <AutoAwesome />,
    logo: '/images/certifications/linkedin.png',
    description:
      'LinkedIn Learning Certificate for Generative AI: The Evolution of Thoughtful Online Search.',
    skills: [
