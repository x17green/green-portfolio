...
export const projectsData = [
  {
    ...
    description:
      "A comprehensive platform that leverages multiple LLMs (GPT-4, Claude, Gemini) with sophisticated prompt engineering techniques to generate high-quality content across various domains. Features include chain-of-thought prompting, few-shot learning, and dynamic prompt optimization.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "An autonomous trading system using LSTM networks and transformer models to analyze market patterns, predict price movements, and execute trades. Incorporates sentiment analysis from news and social media data.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "A computer vision system that assists healthcare professionals in diagnosing medical conditions from X-rays, MRIs, and CT scans using convolutional neural networks and transfer learning.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "A sophisticated recommendation system using collaborative filtering, content-based filtering, and deep learning to provide personalized product recommendations and optimize user experience.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "A high-performance API service providing real-time translation between 50+ languages using transformer-based neural machine translation models with context awareness and domain adaptation.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "A comprehensive chatbot platform featuring natural language understanding, intent classification, entity extraction, and dialogue management for customer service automation.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "An innovative platform that generates unique artwork using Generative Adversarial Networks and diffusion models, featuring style transfer, prompt-based generation, and NFT marketplace integration.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "An intelligent research tool that automatically summarizes academic papers, extracts key insights, identifies research gaps, and suggests related work using advanced NLP and knowledge graphs.",
    longDescription:
