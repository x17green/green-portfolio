    ...
    shadows:
      mode === "dark"
        ...
        : [
            ...
            "0px 36px 72px rgba(0, 0, 0, 0.45), 0px 30px 22px rgba(0, 0, 0, 0.22)",
            "0px 42px 84px rgba(0, 0, 0, 0.50), 0px 36px 26px rgba(0, 0, 0, 0.22)",
            "0px 48px 96px rgba(0, 0, 0, 0.55), 0px 42px 30px rgba(0, 0, 0, 0.22)",
            "0px 54px 108px rgba(0, 0, 0, 0.60), 0px 48px 34px rgba(0, 0, 0, 0.22)",
            "0px 60px 120px rgba(0, 0, 0, 0.65), 0px 54px 38px rgba(0, 0, 0, 0.22)",
            "0px 66px 132px rgba(0, 0, 0, 0.70), 0px 60px 42px rgba(0, 0, 0, 0.22)",
            "0px 72px 144px rgba(0, 0, 0, 0.75), 0px 66px 46px rgba(0, 0, 0, 0.22)",
            "0px 78px 156px rgba(0, 0, 0, 0.80), 0px 72px 50px rgba(0, 0, 0, 0.22)",
            "0px 84px 168px rgba(0, 0, 0, 0.85), 0px 78px 54px rgba(0, 0, 0, 0.22)",
            "0px 90px 180px rgba(0, 0, 0, 0.90), 0px 84px 58px rgba(0, 0, 0, 0.22)",
            "0px 96px 192px rgba(0, 0, 0, 0.95), 0px 90px 62px rgba(0, 0, 0, 0.22)",
            "0px 102px 204px rgba(0, 0, 0, 1.00), 0px 96px 66px rgba(0, 0, 0, 0.22)",
            "0px 108px 216px rgba(0, 0, 0, 1.00), 0px 102px 70px rgba(0, 0, 0, 0.22)",
            "0px 114px 228px rgba(0, 0, 0, 1.00), 0px 108px 74px rgba(0, 0, 0, 0.22)",
            "0px 120px 240px rgba(0, 0, 0, 1.00), 0px 114px 78px rgba(0, 0, 0, 0.22)",
            "0px 126px 252px rgba(0, 0, 0, 1.00), 0px 120px 82px rgba(0, 0, 0, 0.22)",
            "0px 132px 264px rgba(0, 0, 0, 1.00), 0px 126px 86px rgba(0, 0, 0, 0.22)",
          ],
    components: {
      MuiButton: {
        styleOverrides: {
        ...
        styleOverrides: {
          root: {
            ...
            "&:hover": {
              ...
              boxShadow:
                mode === "dark"
                  ? "0px 8px 24px rgba(0, 230, 118, 0.2)"
                  : "0px 8px 24px rgba(0, 230, 118, 0.15)",
